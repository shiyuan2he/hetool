...
import cn.hsy.me.hetool.core.convert.BasicType;
import cn.hsy.me.hetool.core.exceptions.UtilException;
import cn.hsy.me.hetool.core.io.FileUtil;
import cn.hsy.me.hetool.core.io.IORuntimeException;
import cn.hsy.me.hetool.core.io.resource.ResourceUtil;
import cn.hsy.me.hetool.core.lang.Assert;
import cn.hsy.me.hetool.core.lang.ClassScanner;
import cn.hsy.me.hetool.core.lang.Filter;
import cn.hsy.me.hetool.core.lang.Singleton;
...
public class ClassUtil {
	 ...
	 *
	 * <pre>
	 * isSimple为false: "com.xiaoleilu.hetool.util.ClassUtil"
	...
	/**
	 * 获取完整类名的短格式如：<br>
	 * cn.hsy.me.hetool.core.util.StrUtil -》c.h.c.u.StrUtil
	 *
	 * @param className 类名
	 * @return 短格式类名
	 * @since 4.1.9
	 ...
	 *
	 * @param <T>                     对象类型
	 * @param classNameWithMethodName 类名和方法名表达式，类名与方法名用<code>.</code>或<code>#</code>连接 例如：com.xiaoleilu.hetool.StrUtil.isEmpty 或 com.xiaoleilu.hetool.StrUtil#isEmpty
	 ...
	 *
	 * @param <T>                     对象类型
	 * @param classNameWithMethodName 类名和方法名表达式，例如：com.xiaoleilu.hetool.StrUtil#isEmpty或com.xiaoleilu.hetool.StrUtil.isEmpty
	 ...
	 * 获得给定类所在包的名称<br>
	 * 例如：<br>
	 * com.xiaoleilu.hetool.util.ClassUtil =》 com.xiaoleilu.hetool.util
	 *
	 * @param clazz 类
	 * @return 包名
	 */
