package cn.hsy.me.hetool.core.bean;
...
import cn.hsy.me.hetool.core.bean.BeanDesc.PropDesc;
import cn.hsy.me.hetool.core.bean.copier.BeanCopier;
import cn.hsy.me.hetool.core.bean.copier.CopyOptions;
import cn.hsy.me.hetool.core.bean.copier.ValueProvider;
import cn.hsy.me.hetool.core.collection.CollUtil;
import cn.hsy.me.hetool.core.convert.Convert;
import cn.hsy.me.hetool.core.lang.Editor;
import cn.hsy.me.hetool.core.lang.Filter;
import cn.hsy.me.hetool.core.map.CaseInsensitiveMap;
import cn.hsy.me.hetool.core.map.MapUtil;
import cn.hsy.me.hetool.core.util.ArrayUtil;
...
public class BeanUtil {
	 ...
	 * 如果isSimple为{@code false}，则只匹配类名而忽略包名，例如：cn.hsy.me.hetool.TestEntity只匹配TestEntity<br>
	 * 如果isSimple为{@code true}，则匹配包括包名的全类名，例如：cn.hsy.me.hetool.TestEntity匹配cn.hsy.me.hetool.TestEntity
	 *
	 * @param bean          Bean
