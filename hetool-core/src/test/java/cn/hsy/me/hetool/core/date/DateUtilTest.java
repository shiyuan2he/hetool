...
import cn.hsy.me.hetool.core.date.BetweenFormater.Level;
...
public class DateUtilTest {
    ...
    @Test
    public void betweenTest0() {
        String dateStr1 = "2017-03-01 22:34:23";
        Date date1 = DateUtil.parse(dateStr1);

        String dateStr2 = "2017-03-02 22:56:14";
        Date date2 = DateUtil.parse(dateStr2);

        String dateStr3 = "2017-03-01 22:34:23";
        Date date3 = DateUtil.parse(dateStr3);

        String dateStr4 = "2017-03-02 22:33:14";
        Date date4 = DateUtil.parse(dateStr4);
        // 相差小时
        long betweenHour = DateUtil.between(date1, date2, DateUnit.HOUR);
        Assert.assertEquals(true, betweenHour>=24);

        Assert.assertEquals(false, DateUtil.between(date3, date4, DateUnit.HOUR)>=24);
    }
	@Test
